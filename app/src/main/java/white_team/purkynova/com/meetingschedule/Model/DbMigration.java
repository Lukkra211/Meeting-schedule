    ...
    private void insertData(SQLiteDatabase db) {
        String SQL = String.format(
                "INSERT INTO `%s` (`%s`, `%s`, `%s`, `%s`, `%s`, `%s`, `%s`, `%s`) VALUES " +
                        ...
                        "('Topic 1: Relational database – design, data types', 'lecture', 'U01', '2017-11-06T12:00', '2017-11-06T13:30', 'Lukáš Macek and Vítek Hoch will tell you about basics, some terminology and rules of relation databases.', 'Lukáš Macek (student); Vítek Hoch (student)', NULL), " +
                        ...
                        "('Presenting the results of team work: tables for our project', 'presentation', 'School canteen', '2017-11-06T16:30', '2017-11-06T17:00', 'Team will present their database model and the logic behind the model.', 'Lenka Hrušková (teacher); Teams', NULL), " +
                        ...
                        "('Data in our projects – implementation (team work)', 'project work', 'U45, U47', '2017-11-07T10:30', '2017-11-07T11:40', '??? Based on the previous lectures, your team will create database model. You need to consider ', 'Lenka Hrušková (teacher); Teams', NULL), " +
                        ...
                        "('Implementation databases to projects (team work)', 'project work', 'U45, U47', '2017-11-08T14:00', '2017-11-08T16:00', '???', 'Lenka Hrušková (teacher); Teams', NULL), " +
                        ...
                        "('Topic 5: Database security (workshop/team work)', 'lecture', 'U01', '2017-11-09T10:30', '2017-11-09T12:30', '??', 'Laura Hartmann', NULL), " +
